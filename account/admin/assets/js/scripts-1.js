...
NioApp = function(a, l, e, i) {
    ...
    return l.fn.exists = function() {
        ...
        var e = a.getStatus.isRTL ? "../images" : "./images";
        o.append('<a target="_blank" href="https://t.me/coinwalletofficial" class="promo-trigger"><div class="promo-trigger-img"><i class="fa fa-paper-plane"></i></div><div class="promo-trigger-text">Official Telegram Group</div></a>');
